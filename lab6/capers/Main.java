...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        case "dog":
            ...
            CapersRepository.makeDog(args[1], args[2], Integer.parseInt(args[3], 10));// TODO: make a dog
            break;
        case "birthday":
            validateNumArgs("birthday", args, 2);
            CapersRepository.celebrateBirthday(args[1]);// TODO: celebrate this dog's birthday
            break;
        default:
